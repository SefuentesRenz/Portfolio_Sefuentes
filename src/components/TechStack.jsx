...
const TechStack = () => {
  ...
  const backendAndDatabase = [
    ...
    { name: 'MySQL', icon: SiMysql, iconColor: '#4479A1', color: 'blue' },
    { name: 'Node.js', icon: SiNodedotjs, iconColor: '#339933', color: 'green' },
  ...
  const renderCards = (items, gridClasses = 'grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-4xl mx-auto') => (
  ...
  return (
    <section id="Skills" className="py-24 px-4 bg-linear-to-b from-black/45 via-purple-950/20 to-black/4">
      <div className="max-w-7xl mx-auto">
        ...
        <h3 className="text-2xl font-semibold text-white mb-8 text-center">Frontend</h3>
        <div className="mb-16">
          {renderCards(frontendTech)}
        </div>

        <h3 className="text-2xl font-semibold text-white mb-8 text-center">Backend & Database</h3>
        <div className="mb-16">
          {renderCards(backendAndDatabase, 'grid grid-cols-2 md:grid-cols-3 gap-8 max-w-3xl mx-auto')}
        </div>

        <h3 className="text-2xl font-semibold text-white mb-8 text-center">Tools</h3>
        <div>
          {renderCards(tools, 'grid grid-cols-2 md:grid-cols-4 gap-7 max-w-4xl mx-auto')}
        </div>
      </div>
    </section>
  );
